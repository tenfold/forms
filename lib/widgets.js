...
var input = function (type) {
    var dataRegExp = /^ng-[a-z]+([-][a-z]+)*$/,
        ariaRegExp = /^aria-[a-z]+$/,
        legalAttrs = ['popover', 'popover-placement', 'popover-trigger', 'autocomplete', 'autocorrect', 'autofocus', 'autosuggest', 'checked', 'dirname', 'disabled', 'tabindex', 'list', 'max', 'maxlength', 'min', 'multiple', 'novalidate', 'pattern', 'placeholder', 'readonly', 'required', 'size', 'step'],
